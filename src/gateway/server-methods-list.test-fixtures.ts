// Advertised core method order from c79c8c4c0aa79f227ffa4fbb13b9ccf001057758.
...
users.setAvatar users.setRole tasks.list tasks.get tasks.cancel taskSuggestions.list
...
transcripts.list transcripts.get models.authOrderSet
`
  .trim()
  .split(/\s+/u);
